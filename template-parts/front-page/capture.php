<div class="container bold narrow">
	<div class="row">
		<header class="">
			<h4>
				<div class="display-md centered">A Free Gift For You</div>
			</h4>
		</header>
		...
		<div class="content">
			<div class="grid">
				...
				<div>
					<header class="fz-md fw-semibold centered">
					...
					<ul>
						...
						<li>How to deal with your fears and doubts about going after this</li>
						<li>How to find a good teacher</li>
					</ul>
					...
					<div class="centered">
						<?php echo do_shortcode('[pmpro_signup level="1" short="emailonly" login="true" title="true" submit_button="Get Free Lessons" intro="false" custom_fields="true" redirect="/welcome-free-membership/"]'); ?>
